...
class AudioButtons(discord.ui.View):
    ...
    async def reroll(self, interaction, btn):
        ...
        (_, videos, sound_fnames), _ = await audio_gen.generate_audio(params)
...
class AudioEditModal(ui.Modal, title="Edit/Extend Sound"):
    def __init__(self, params: AudioWorkflow, command: str):
        ...
        self.cfg = ui.TextInput(
            ...
            placeholder="Controls audio's conformance to text prompt; default 1.0",
    ...
    async def on_submit(self, interaction: discord.Interaction) -> None:
        ...
        try:
            ...
            interaction.response.send_message("An error occurred while parsing a value you entered. Please check your inputs and try your request again.", ephemeral=True)
